...
infile <- 'KpCip3_allRespNormFold_runs1-2-4.csv'
outfile <- 'KpCip3_allRespNormFold_runs1-2-4.RData'
MICMid <- 0.5
...
names(MIC1) <- strain2
MIC <- sort(MIC1)
lclass3 <- lclass2[names(MIC)] 

# Consider the intermediate sample as 'R'
lclass3['RB418'] <- 'R'
lclass <- factor(lclass3)
